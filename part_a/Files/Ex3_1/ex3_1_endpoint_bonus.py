"""Solution to Exercise 3.1: Dictionaries, Sets, and Looping bonus.
...
if flight_list[0] in city_code_dictionary and flight_list[1] in city_code_dictionary:
    print("Both", flight_list[0], "and", flight_list[1], "are keys")
else:
    print("We do not fly from", flight_list[0], "to", flight_list[1])
...
keylist.sort()
for key in keylist:
    print(key, flight_dictionary[key])
